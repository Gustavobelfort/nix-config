...
in
{
  ...
  wayland.windowManager.hyprland = {
    extraConfig = ''
      ...
      exec-once = mako &
      exec-once = nm-applet &
      exec-once = swayidle -w timeout 900 'systemctl suspend' before-sleep '${myswaylock}/bin/myswaylock' after-resume 'hyprctl dispatch dpms on'
