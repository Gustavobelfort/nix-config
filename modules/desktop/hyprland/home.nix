...

{
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      bind = $mainMod, A, workspace,PASS
      bind = $mainMod, S, workspace,SLK
      bind = $mainMod, D, workspace,DSC
      ...
      windowrule=opacity 0.95,title:1Password
      windowrule=opacity 0.95,title:Slack
      ...
      windowrule=workspace name:DSC, title:Discord
      windowrule=workspace name:SLK, title:Slack
      windowrule=workspace name:PASS, title:1Password
